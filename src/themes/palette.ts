...
const Palette = (mode: ThemeMode, presetColor: PresetColor) => {
	...
	return createTheme({
		palette: {
			...
			text: {
				primary:
					mode === 'dark' ? alpha(paletteColor.grey[900]!, 0.87) : paletteColor.grey[700],
				secondary:
					mode === 'dark' ? alpha(paletteColor.grey[900]!, 0.45) : paletteColor.grey[500],
				disabled:
					mode === 'dark' ? alpha(paletteColor.grey[900]!, 0.1) : paletteColor.grey[400]
			},
			action: {
				disabled: paletteColor.grey[300]
			},
			divider:
				mode === 'dark' ? alpha(paletteColor.grey[900]!, 0.05) : paletteColor.grey[200],
			background: {
