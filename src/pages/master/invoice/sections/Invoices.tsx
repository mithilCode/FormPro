...
import { IFormInput } from '@pages/master/invoice/models/Invoices';
...
const Invoices = ({ passProps, selectedData, handleDrawerToggle, setEnableButton1 }: Props) => {
	// add your Dispatch 👿
	...
	const { getSuccess } = invoicesState;
	...
	useEffect(() => {
		...
		dispatch(invoicesActions.get({ QueryParams: queryStirng }));
		return () => {
