...
const citySlice = createSlice({
	...
	reducers: {
		...
		getSuccess(state, action: PayloadAction<cityState>) {
			state.getLoading = false;
			state.getError = null;
			state.getSuccess = action.payload;
		},
		getError(state, action: PayloadAction<cityState>) {
			state.getLoading = false;
		...
		addSuccess(state, action: PayloadAction<cityState>) {
			state.loading = false;
			state.addError = null;
			state.addSuccess = action.payload;
		},
		addError(state, action: PayloadAction<cityState>) {
			state.loading = false;
		...
		editSuccess(state, action: PayloadAction<cityState>) {
			state.loading = false;
			state.editError = null;
			state.editSuccess = action.payload;
		},
		editError(state, action: PayloadAction<cityState>) {
			state.loading = false;
		...
		deleteSuccess(state, action: PayloadAction<cityState>) {
			state.loading = false;
			state.deleteError = null;
			state.deleteSuccess = action.payload;
		},
		deleteError(state, action: PayloadAction<cityState>) {
			state.loading = false;
 ...
 */
export const { actions: cityActions, reducer } = citySlice;
...
export const useCitySlice = () => {
	useInjectReducer({ key: citySlice.name, reducer: citySlice.reducer });
	useInjectSaga({ key: citySlice.name, saga: Saga });
	return { actions: citySlice.actions };
};
