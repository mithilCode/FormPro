...
interface Props {
	passProps?: any;
	tenderLotSeq?: any;
	purityDataOptions?: any;
	currentAction?: any;
	editMode?: any;
}

const TenderViewPuritywise = ({
	passProps,
	purityDataOptions,
	tenderLotSeq,
	currentAction,
	...
	useEffect(() => {
		if (purityDataOptions) {
			setPageState(value => ({
				...value,
				values: {
					...pageState.values,
					para: purityDataOptions
				}
			}));
			setDataSource(purityDataOptions);
		}
	}, [purityDataOptions]);
...
export default TenderViewPuritywise;
