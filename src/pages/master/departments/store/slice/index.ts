...
const departmentSlice = createSlice({
	...
	reducers: {
		...
		getSuccess(state, action: PayloadAction<departmentState>) {
			state.getLoading = false;
			state.getError = null;
			state.getSuccess = action.payload;
		},
		getSuccessDet(state, action: PayloadAction<departmentState>) {
			state.getLoading = false;
			state.getError = null;
			state.getSuccess = action.payload;
		},
		getError(state, action: PayloadAction<departmentState>) {
			state.getLoading = false;
			state.getError = action;
			state.getSuccess = null;
		},
		getErrorDet(state, action: PayloadAction<departmentState>) {
			state.getLoading = false;
			state.getError = action;
			state.getSuccess = null;
		},
		...
		addSuccess(state, action: PayloadAction<departmentState>) {
			state.loading = false;
			state.addError = null;
			state.addSuccess = action.payload;
		},
		addError(state, action: PayloadAction<departmentState>) {
			state.loading = false;
		...
		editSuccess(state, action: PayloadAction<departmentState>) {
			state.loading = false;
			state.editError = null;
			state.editSuccess = action.payload;
		},
		editError(state, action: PayloadAction<departmentState>) {
			state.loading = false;
		...
		deleteSuccess(state, action: PayloadAction<departmentState>) {
			state.loading = false;
			state.deleteError = null;
			state.deleteSuccess = action.payload;
		},
		deleteError(state, action: PayloadAction<departmentState>) {
			state.loading = false;
		...
		getProcSuccess(state, action: PayloadAction<departmentState>) {
			state.getProcLoading = false;
			state.getProcError = null;
			state.getProcSuccess = action.payload;
		},
		getProcError(state, action: PayloadAction<departmentState>) {
			state.getProcLoading = false;
		...
		addDetSuccess(state, action: PayloadAction<departmentState>) {
			state.loading = false;
			state.addDetError = null;
			state.addDetSuccess = action.payload;
		},
		addDetError(state, action: PayloadAction<departmentState>) {
			state.loading = false;
		...
		editDetSuccess(state, action: PayloadAction<departmentState>) {
			state.loading = false;
			state.editDetError = null;
			state.editDetSuccess = action.payload;
		},
		editDetError(state, action: PayloadAction<departmentState>) {
			state.loading = false;
		...
		deleteDetSuccess(state, action: PayloadAction<departmentState>) {
			state.loading = false;
			state.deleteDetError = null;
			state.deleteDetSuccess = action.payload;
		},
		deleteDetError(state, action: PayloadAction<departmentState>) {
			state.loading = false;
 ...
 */
export const { actions: departmentActions, reducer } = departmentSlice;
...
export const useDepartmentSlice = () => {
	useInjectReducer({ key: departmentSlice.name, reducer: departmentSlice.reducer });
	useInjectSaga({ key: departmentSlice.name, saga: Saga });
	return { actions: departmentSlice.actions };
};
