...
export type PatternFormatElementProps<T extends FieldValues = FieldValues> = Omit<
	TextFieldProps,
	'name'
> & {
	...
	control?: Control<T>;
	myCustomProps?: Omit<PatternFormatProps, 'name'>;
	prefix?: string;
	suffix?: string;
	/**
...
// type TypeB = Pick<PatternFormatElementProps, 'thousandSeparator' | 'name'> & CustomProps;
// type TypeB = CalendarEvent extends CustomProps;

export const MaskPatternFormat = forwardRef<PatternFormatProps, CustomProps>(
	function PatternFormatCustom(props, ref) {
		...
		return (
			<PatternFormat
				...
				{...myCustomProps}
				format={myCustomProps?.format ? myCustomProps?.format : ''}
...
// const InputText = forwardRef<PatternFormatProps, CustomProps>((props, ref) => (
// 	<input getInputRef={ref} {...props} />
// ));

export default function PatternFormatElement<TFieldValues extends FieldValues = FieldValues>({
	validation = {},
	parseError,
	type,
	required,
	...
	suffix,
	...rest
}: PatternFormatElementProps<TFieldValues>): JSX.Element {
		...
		<Controller
			...
			render={({ field: { value, onChange, onBlur, ref }, fieldState: { error } }) => (
				<TextFieldComponent
					...
					type={type}
					InputProps={{
						inputComponent: MaskPatternFormat as any,
