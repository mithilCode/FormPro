...
// ==============================|| AUTH BLUR BACK SVG ||============================== //
// import logo from 'assets/images/DXL_LOGO_PNG.png';
...
const AuthBackground = () => {
	...
	return (
		...
		<Box sx={{ position: 'absolute', filter: 'blur(18px)', zIndex: -1, bottom: 0 }}>
			{/* <img src={logo} alt="Mantis" width="100%" height="calc(100vh - 175px)"  style={{position: "relative",float: "right",marginTop: -51 }}/> */}
			{/* <svg
				width="100%"
