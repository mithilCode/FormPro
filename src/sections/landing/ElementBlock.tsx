...
const ElementBlock = () => {
	...
	const checkIcon = (
		<CheckCircleOutlined style={{ color: theme.palette.primary.main, fontSize: '1.15rem' }} />
	);
								...
								<Grid container spacing={1} justifyContent="center">
									...
									<Grid item xs={12}>
										<Typography variant="body1">
											Create your powerful backend project using powerful
											design system of DXLOne-Mfg Template.
										</Typography>
									</Grid>
								</Grid>
							</Grid>
					...
					<Grid item xs={9}>
						<Box sx={{ position: 'relative', mb: 3 }}>
							<motion.div
								...
								<CardMedia
									component="img"
									image={dashImage(`./img-element-main-${presetColor}.png`)}
