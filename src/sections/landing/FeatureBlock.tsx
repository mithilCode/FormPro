						...
						<Grid container spacing={1} justifyContent="center">
							...
							<Grid item xs={12}>
								<Typography variant="body1">
									{/* Customize everything with the Mantis React Material-UI Dashboard
									Template built with latest MUI v5 component library */}
								</Typography>
							</Grid>
						</Grid>
					</Grid>
						...
						<Grid container spacing={1}>
							...
							<Grid item xs={12}>
								<Typography variant="body1" color="secondary">
									Mantis has fully professional grade user interface for any kind
									of backend project.
								</Typography>
							</Grid>
						</Grid>
